...
class SurvivalFFNNRFS(SurvivalNeuralNet):
    def __init__(self, model_name, cancer, omics_type, out_folder, epochs=1000, vecdim=10):
        super(SurvivalFFNNRFS, self).__init__(model_name, cancer, omics_type, out_folder, epochs)
        self.vecdim = vecdim
    ...
    def feature_selection(self, x, c, s, xnames, fold, sel_f_num, dev_index):  
        ...
        save_feature_file = self.out_folder+'/FFNNRFS/selected_features_'+self.cancer_type+'_'+self.omics_type+'_'+str(fold)+'.csv'
